...
import 'package:one_page/Screens/Home/products/product_section_all.dart';
...
class ProductsScreenWidget extends StatefulWidget {
  ...
  final Sublinea sublineas;
  List<sucursales> sucurales;

  final Linea lineas;
   ProductsScreenWidget({Key key, this.articulo, this.familias, this.sublineas, this.lineas}) : super(key: key);

  @override
  _ProductsScreenWidgetState createState() => _ProductsScreenWidgetState();
}
