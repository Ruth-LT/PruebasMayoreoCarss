...
class Dealers3 extends StatefulWidget {
  Dealers3({Key key}) : super(key: key);

  @override
  State<Dealers3> createState() => _Dealers3State();
}

class _Dealers3State extends State<Dealers3> {
      ...
      child: Wrap(
        children: [
          Container(
            ...
            height: Responsive.isMobile(context) ? 200 : 550,
            child: Container(
              width: 10,
              height: 10,
              decoration: BoxDecoration(
                  image: DecorationImage(
                image: AssetImage("assets/Senfineco.jpeg"),
              )),
            ),
          ),
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding:
                      EdgeInsets.only(left: 30, top: 0, bottom: 0, right: 30),
                  child: Container(
